...
def run(settings):
    ...
    dataset_train = sampler.ATOMSampler([lasot_train, trackingnet_train, got10k_train], [1,4,4],
                                         samples_per_epoch=2000*settings.batch_size, max_gap=60,
    ...
    dataset_val = sampler.ATOMSampler([trackingnet_val, got10k_val], [1,1], samples_per_epoch=500*settings.batch_size, max_gap=60,
    ...
    # Create network  
    net = SBDT_models.SBDT_resnet50(backbone_pretrained=True)
