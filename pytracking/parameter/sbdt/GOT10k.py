...
def parameters(ID=None):
    ...
    params.hard_negative_learning_rate = 0.15     # Learning rate if hard negative samples are detected
    ...
    params.window_sigma_factor = 1.3   # Standard deviation of Gaussian output window relative to target size
