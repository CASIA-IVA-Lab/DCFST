...
def parameters(ID=None):
    ...
    params.learning_rate = 0.018                 # Learning rate to update locator features model 
    ...
    params.target_not_found_threshold = 0.1      # Absolute score threshold to detect target missing
    ...
    params.hard_negative_threshold = 0.15         # Absolute threshold to find hard negative samples
    params.hard_negative_learning_rate = 0.16     # Learning rate if hard negative samples are detected 
    ...
    params.window_sigma_factor = 0.8    # Standard deviation of Gaussian output window relative to target size
    params.window_min = 0.4             # Min value of the output window

    # Scale update
    params.scale_damp = 0.5     # Linear interpolation coefficient for target scale update
    ...
    # Scale bounds
    params.min_scale_factor = 0.166    # Min value of the scale bound
    params.max_scale_factor = 6.000    # Max value of the scale bound
