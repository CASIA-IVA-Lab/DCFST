...
class MSCOCOSeq(BaseDataset):
    ...
    def _get_sequence_list(self):
        ...
        seq_list = [a for a in seq_list if self.coco_set.anns[a]['area'] > 100]
        seq_list = [a for a in seq_list if (self.coco_set.anns[a]['bbox'][2]/self.coco_set.anns[a]['bbox'][3] < 5 and self.coco_set.anns[a]['bbox'][3]/self.coco_set.anns[a]['bbox'][2] < 5)]
