...
def parameters(ID=None):
    ...
    params.learning_rate = 0.01                  # Learning rate to update locator features model 
    ...
    params.target_not_found_threshold = 0.3      # Absolute score threshold to detect target missing
    ...
    params.hard_negative_learning_rate = 0.1      # Learning rate if hard negative samples are detected
    ...
    params.window_min = 0.6             # Min value of the output window
